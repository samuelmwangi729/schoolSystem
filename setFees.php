									...
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<thead class="text-center">
											<tr>
												...
												echo $CurrentTerm;
													?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Print.php?Print=1&Term=<?php echo $CurrentTerm;?>" class="fa fa-print badge badge-success text-right" style="margin-left:200px">Print Fees</a></td>
											</tr>
											<tr>
									...
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<thead class="text-center">
											<tr>
												...
												$database->execute();
												echo $database->fetchColumn();
													?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Print.php?Print=2&Term=<?php echo $CurrentTerm;?>" class="fa fa-print badge badge-success text-right" style="margin-left:200px">Print Fees </a></td>
											</tr>
											<tr>
												<td><?php echo "Votehead";?></td>
												<td><?php echo "Amount";?></td>
									...
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<thead class="text-center">
											<tr>
												...
												$database->execute();
												echo $database->fetchColumn();
													?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Print.php?Print=3&Term=<?php echo $CurrentTerm;?>" class="fa fa-print badge badge-success text-right" style="margin-left:200px">Print Fees </a></td>
											</tr>
											<tr>
												<td><?php echo "Votehead";?></td>
												<td><?php echo "Amount";?></td>
									...
									<table class="table table-striped table-condensed table-hover table-bordered">
										...
										<thead class="text-center">
											<tr>
												...
												$CurrentTerm=$database->fetchColumn();
												echo $CurrentTerm;
													?> <a href="Print.php?Print=4&Term=<?php echo $CurrentTerm;?>" class="fa fa-print badge badge-success text-right" style="margin-left:200px">Print Fees </a></td>
											</tr>
											<tr>
												<td><?php echo "Votehead";?></td>
												<td><?php echo "Amount";?></td>
