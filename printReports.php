    ...
    function viewTable($db){
     ...
     if($c2){
      ...
      $this->Cell(30,7,"Total Points: ". $pts,1,0,'C');
        ...
        $this->SetFont('Arial','B',8);
        $this->Ln();
        $this->Cell(190,5,"The School Closes today on ".date('Y-m-d')." And we Resume back to School on ".$db->getOpeningDate().".",0,0,'L');
        $this->Ln();
        $this->Cell(190,5,"The student Has An outstanding balance of ".$db->getBalance($_SESSION['regNo'])." Which should be cleared upon reporting"." " ,0,0,'L');
        $this->Ln(5);
        $db=new Database();
        $term=$db->getNextTerm();
        ...
        $this->Cell(190,5,"The next term fees is ".$total." Ksh",0,0,'L');
        $this->Ln(10);
        $this->SetTextColor(0,0,0);
